				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="电影分类" prop="dianyingfenlei">
							<el-input class="list_inp" v-model="form.dianyingfenlei" placeholder="电影分类"
								 type="text" 								:readonly="!isAdd||disabledForm.dianyingfenlei?true:false" />
						</el-form-item>
					</el-col>
