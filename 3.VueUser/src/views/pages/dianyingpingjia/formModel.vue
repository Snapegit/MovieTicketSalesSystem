			...
			<div class="info_view">
				<div class="title_view">
					<div class="detail_title">
						{{detail.dianyingyuanmingcheng}}
					</div>
				</div>
				<div class="info_item">
					<div class="info_label">电影名称</div>
					<div  class="info_text" >{{detail.dianyingmingcheng}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">评价时间</div>
					<div  class="info_text" >{{detail.pingjiashijian}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('dianyingpingjia','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('dianyingpingjia','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
...
<script setup>
	...
	const getDetail = () => {
		context?.$http({
			...
			title.value = res.data.data.dianyingyuanmingcheng
