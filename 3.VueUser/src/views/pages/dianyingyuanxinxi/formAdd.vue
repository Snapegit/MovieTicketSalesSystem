	...
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"0px","background":"#fff","width":"76%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				...
				<el-col :span="8">
					<el-form-item label="电影院规模" prop="dianyingyuanguimo">
						<el-input class="list_inp" v-model="form.dianyingyuanguimo" placeholder="电影院规模"
							 type="text" 							:readonly="!isAdd||disabledForm.dianyingyuanguimo?true:false" />
					</el-form-item>
				</el-col>

				<el-col :span="8">
					<el-form-item label="放映厅数" prop="fangyingtingshu">
						<el-input class="list_inp" v-model="form.fangyingtingshu" placeholder="放映厅数"
							 type="text" 							:readonly="!isAdd||disabledForm.fangyingtingshu?true:false" />
					</el-form-item>
				</el-col>
...
<script setup>
	...
	const disabledForm = ref({
		...
		dizhi : false,
		lianxifangshi : false,
		dianyingyuanguimo : false,
		fangyingtingshu : false,
		fengmian : false,
	})
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='dianyingyuanguimo'){
					form.value.dianyingyuanguimo = row[x];
					disabledForm.value.dianyingyuanguimo = true;
					continue;
				}
				if(x=='fangyingtingshu'){
					form.value.fangyingtingshu = row[x];
					disabledForm.value.fangyingtingshu = true;
					continue;
				}
				if(x=='fengmian'){
