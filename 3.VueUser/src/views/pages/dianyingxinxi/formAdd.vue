			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="电影简介" prop="dianyingjianjie">
						<editor class="list_editor" :value="form.dianyingjianjie" placeholder="请输入电影简介" :readonly="!isAdd||disabledForm.dianyingjianjie?true:false"
							@change="(e)=>editorChange(e,'dianyingjianjie')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.dianyingjianjie = res.data.data.dianyingjianjie.replace(reg,'../../../cl4591503/file');
